  ...
  window.needShareButton = function (elem, options) {
    ...
    root.share = {
      ...
      "qq": function (el) {
        ...
        "&title=" + encodeURIComponent(myoptions.title) + 
        "&summary=" + encodeURIComponent(myoptions.description) +
        "&pics=" + "https://lucunji.github.io/avatar.jpg";
        root.popup(url)
      },
      "qqzone": function (el) {
        var myoptions = getOptions(el);
    ...
    root.options = {
      ...
      networks: "Weibo,Wechat,Douban,QQZone,QQ,Twitter,Pinterest,Facebook,GooglePlus,Reddit,Linkedin,Tumblr,Evernote"
    };
    ...
    function createDropdown(el) {
      ...
      for (var network in myoptions.networks) {
        if (myoptions.networks.hasOwnProperty(network)) {
          ...
          var fontello = ["weibo", "wechat", "douban", "qqzone", "qq", "renren"];
